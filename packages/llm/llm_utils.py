...
class OpenAICost:
    """OpenAI pricing information organized by model"""
    ...
    class GPT_4O_FINE_TUNING:
        input = 3.75
        cached_input = 1.875
        output = 15.00
        training = 25.00

    class GPT_4O_MINI_FINE_TUNING:
        input = 0.30
        cached_input = 0.15
        output = 1.20
        training = 3.00
...
class GeminiCost:
    """Gemini pricing information organized by model"""

    class GEMINI_2_5_FLASH_PREVIEW_05_20:
        input = 1.25
        output = 1.50
